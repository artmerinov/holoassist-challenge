...
class BNInception(nn.Module):
    ...
    def _block_3a(self, pool2_3x3_s2_out):
        ...
        inception_3a_gsf_1x1_out = self.inception_3a_gsf_1x1(inception_3a_1x1_out)
        inception_3a_1x1_bn_out = self.inception_3a_1x1_bn(inception_3a_gsf_1x1_out) # same
    ...
    def _block_3b(self, inception_3a_output_out):
        ...
        inception_3b_gsf_1x1_out = self.inception_3b_gsf_1x1(inception_3b_1x1_out)
        inception_3b_1x1_bn_out = self.inception_3b_1x1_bn(inception_3b_gsf_1x1_out) # same
    ...
    def _block_3c(self, inception_3b_output_out):
        ...
        inception_3c_gsf_3x3_reduce_out = self.inception_3c_gsf_3x3_reduce(inception_3c_3x3_reduce_out)
        inception_3c_3x3_reduce_bn_out = self.inception_3c_3x3_reduce_bn(inception_3c_gsf_3x3_reduce_out)
    ...
    def _block_4a(self, inception_3c_output_out):
        ...
        inception_4a_gsf_1x1_out = self.inception_4a_gsf_1x1(inception_4a_1x1_out)
        inception_4a_1x1_bn_out = self.inception_4a_1x1_bn(inception_4a_gsf_1x1_out)
    ...
    def _block_4b(self, inception_4a_output_out):
        ...
        inception_4b_gsf_1x1_out = self.inception_4b_gsf_1x1(inception_4b_1x1_out)
        inception_4b_1x1_bn_out = self.inception_4b_1x1_bn(inception_4b_gsf_1x1_out)
    ...
    def _block_4c(self, inception_4b_output_out):
        ...
        inception_4c_gsf_1x1_out = self.inception_4c_gsf_1x1(inception_4c_1x1_out)
        inception_4c_1x1_bn_out = self.inception_4c_1x1_bn(inception_4c_gsf_1x1_out)
    ...
    def _block_4d(self, inception_4c_output_out):
        ...
        inception_4d_gsf_1x1_out = self.inception_4d_gsf_1x1(inception_4d_1x1_out)
        inception_4d_1x1_bn_out = self.inception_4d_1x1_bn(inception_4d_gsf_1x1_out)
    ...
    def _block_4e(self, inception_4d_output_out):
        ...
        inception_4e_gsf_3x3_reduce_out = self.inception_4e_gsf_3x3_reduce(inception_4e_3x3_reduce_out)
        inception_4e_3x3_reduce_bn_out = self.inception_4e_3x3_reduce_bn(inception_4e_gsf_3x3_reduce_out)
    ...
    def _block_5a(self, inception_4e_output_out):
        ...
        inception_5a_gsf_1x1_out = self.inception_5a_gsf_1x1(inception_5a_1x1_out)
        inception_5a_1x1_bn_out = self.inception_5a_1x1_bn(inception_5a_gsf_1x1_out)
    ...
    def _block_5b(self, inception_5a_output_out):
        ...
        inception_5b_gsf_1x1_out = self.inception_5b_gsf_1x1(inception_5b_1x1_out)
        inception_5b_1x1_bn_out = self.inception_5b_1x1_bn(inception_5b_gsf_1x1_out)
    ...
    def _build_features(self, inplace, num_classes):
        ...
        self.inception_3a_gsf_1x1 = GSM(64, num_segments=self.num_segments, gsf_ch_ratio=self.gsf_ch_ratio)
        ...
        self.inception_3b_gsf_1x1 = GSM(64, num_segments=self.num_segments, gsf_ch_ratio=self.gsf_ch_ratio)
        ...
        self.inception_3c_gsf_3x3_reduce = GSM(128, num_segments=self.num_segments, gsf_ch_ratio=self.gsf_ch_ratio)
        ...
        self.inception_4a_gsf_1x1 = GSM(224, num_segments=self.num_segments, gsf_ch_ratio=self.gsf_ch_ratio)
        ...
        self.inception_4b_gsf_1x1 = GSM(192, num_segments=self.num_segments, gsf_ch_ratio=self.gsf_ch_ratio)
        ...
        self.inception_4c_gsf_1x1 = GSM(160, num_segments=self.num_segments, gsf_ch_ratio=self.gsf_ch_ratio)
        ...
        self.inception_4d_gsf_1x1 = GSM(96, num_segments=self.num_segments, gsf_ch_ratio=self.gsf_ch_ratio)
        ...
        self.inception_4e_gsf_3x3_reduce = GSM(128, num_segments=self.num_segments, gsf_ch_ratio=self.gsf_ch_ratio)
        ...
        self.inception_5a_gsf_1x1 = GSM(352, num_segments=self.num_segments, gsf_ch_ratio=self.gsf_ch_ratio)
        ...
        self.inception_5b_gsf_1x1 = GSM(352, num_segments=self.num_segments, gsf_ch_ratio=self.gsf_ch_ratio)
...
def bninception(pretrained: str = 'imagenet', 
                num_classes: int = 1000, 
                num_segments: int = 8, 
                gsf_ch_ratio: int = 100,
):
    """
