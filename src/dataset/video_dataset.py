...
def prepare_clips_data(
    ...
    return clip_path_to_video_arr, clip_start_arr, clip_end_arr, clip_action_id_arr
...
class VideoDataset(Dataset):
    ...
    def __init__(
        ...
        self.clip_action_id_arr = clip_action_id_arr
    ...
    def __getitem__(self, index: int):
        ...
        clip_action_id = self.clip_action_id_arr[index]
