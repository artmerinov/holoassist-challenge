...
# ========================= Paths ==========================
parser.add_argument("--holoassist_dir", 
                    type=str, 
                    default="/Users/artemmerinov/data/holoassist", 
                    help="Path to dataset directory")
parser.add_argument("--raw_annotation_file", 
                    type=str, 
                    default="/Users/artemmerinov/data/holoassist/data-annotation-trainval-v1_1.json", 
                    help="Path to raw annotation file")
parser.add_argument("--split_dir",
                    type=str, 
                    default="/Users/artemmerinov/data/holoassist/data-splits-v1", 
                    help="Path to split directory")
parser.add_argument("--fine_grained_actions_map_file",
                    type=str, 
                    default="/Users/artemmerinov/data/holoassist/fine_grained_actions_map.txt", 
                    help="Path fine-grained actions map file")
...
parser.add_argument("--base_model", type=str, default="BNInception", 
                    choices=["resnet50", "resnet101", "BNInception", "InceptionV3"])
...
parser.add_argument("--resume",
                    type=str, 
                    default=None, 
                    help="Path to model to continue learning.")
