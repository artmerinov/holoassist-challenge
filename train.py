...
if __name__ == "__main__":
    ...
    for epoch in range(args.start_epoch, args.num_epochs):
        ...
        for tr_batch_id, tr_batch in enumerate(tr_dataloader):
            ...
            tr_epoch_acc1.update(value=tr_acc1, n=args.batch_size)
            tr_epoch_acc5.update(value=tr_acc5, n=args.batch_size)

            if tr_batch_id % 20 == 0:

                # print("tr_x", tr_x[0][0], tr_x[0][1])
                # print("tr_y", tr_y)
        ...
        checkpoint_fn = f"{args.dataset_name}_{args.base_model}_{args.fusion_mode}_{epoch:02d}.pth"
