...
#     --lr 0.01 \
#     --clip_gradient 20 \
#     | tee -a logs/train_inceptionv3_gsf.log &
...
#     --resume /data/amerinov/projects/holoassist/checkpoints/holoassist_TimeSformer_None_action_06.pth \
#     --dropout 0.5 \
#     --num_epochs 10 \
#     --batch_size 16 \
#     --prefetch_factor 4 \
...
#     --lr 0.01 \
#     --clip_gradient 20 \
#     | tee -a logs/train_timesformer.log &
