...
python3 -B /data/users/amerinov/projects/holoassist/eval_action.py \
    ...
    --num_segments 16 \
    --repetitions 10 \
    --checkpoint /data/users/amerinov/projects/holoassist/checkpoints/GSF_ResNet50_ImageNet_bs32_ns8/GSF_ResNet50_ImageNet_bs32_ns8_ep11.pth \
    | tee -a /data/users/amerinov/projects/holoassist/logs/eval_GSF_ResNet50_ImageNet_bs32_ns8.log
