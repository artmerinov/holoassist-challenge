...
python3 -B /data/users/amerinov/projects/holoassist/eval_action.py \
    ...
    --num_segments 16 \
    --repetitions 10 \
    --checkpoint /data/users/amerinov/projects/holoassist/checkpoints/TSM_InceptionV3_SS1_bs32_ns16/TSM_InceptionV3_SS1_bs32_ns16_ep15.pth \
    | tee -a /data/users/amerinov/projects/holoassist/logs/eval_TSM_InceptionV3_SS1_bs32_ns16.log
